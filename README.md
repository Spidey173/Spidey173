...
<h1 align="center">Backend Engineer, building with LLMs</h1>
...
I build backend systems that hold up under real conditions — webhooks that don't double-fire, retrieval pipelines that return the right chunk, sockets that stay in sync under concurrent writes.
...
FastAPI + Next.js SaaS-style app that verifies inbound GitHub webhooks with HMAC-SHA256, processes them asynchronously via background tasks, and deduplicates deliveries to prevent repeat triggers.
`Live:` [git-hub-automation-bot-mvp.vercel.app](https://git-hub-automation-bot-mvp.vercel.app/)

### 🔹 [Expert Booking System](https://github.com/Spidey173/Expert-Booking-System.git) — real-time booking platform
React + Node/Express + MongoDB + Socket.io app for live expert-session booking. Uses MongoDB compound unique indexes and atomic `findOneAndUpdate` calls to eliminate double-booking race conditions, with sub-100ms real-time UI sync.
`Live:` [expert-booking-system-lovat.vercel.app](https://expert-booking-system-lovat.vercel.app/)
...
|---|---|---|
| [ChibiBytes](https://github.com/Spidey173/ChibiBytes) | Anime discovery platform with watchlists and a Gemini-powered assistant that queries local catalog data before falling back to the LLM · [demo](https://chibibytes-vutq.onrender.com) | Flask, SQLite, Gemini API |
| [CogniStream](https://github.com/Spidey173/CogniStream.git) | Containerized real-time computer vision system — ingests webcam frames over WebSockets, computes face ROI with MediaPipe, renders boxes in pure NumPy, streams MJPEG | FastAPI, React, MediaPipe, PostgreSQL, Docker |
| [Zyraa](https://github.com/Spidey173/Zyraa.git) | Django social platform (posts, reels, stories) — optimized with `select_related`/`prefetch_related` to kill N+1 query loops, Cloudinary for media | Django, PostgreSQL, Cloudinary |
| [Glitch4ce](https://github.com/Spidey173/Glitch4ce.git) | Interactive gaming hub — 15+ mini-games across 30+ genres with session auth and gameplay tracking · [demo](https://glitch4ce-8qk3.onrender.com/) | Flask, SQLite |

---

## 💻 Tech I use

**Backend** — Python (FastAPI, Django, Flask) · Node.js (Express) · REST APIs · WebSockets · async I/O
**AI / RAG** — FAISS · Sentence-Transformers · Gemini API (`google-genai`) · LangChain · Cross-Encoder Reranking
**Data** — PostgreSQL · MongoDB · SQLite · Redis
**Frontend** — React · Next.js · TypeScript · Tailwind CSS
**Infra** — Docker · Git/GitHub · GitHub Actions · Vercel · Render · Supabase
...
<p align="center">
  <img height="165" src="https://github-readme-stats.vercel.app/api?username=Spidey173&theme=tokyonight&hide_border=true&show_icons=true&count_private=true" />
  <img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Spidey173&theme=tokyonight&hide_border=true&layout=compact" />
</p>
